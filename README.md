# tempsdecran
3 semaines d'étude du temps d'écran sur smartphone

2. pour obtenir ces données, je me suis servi des rapports hebdomadaires et journaliers de temps d'écran accessible sur Iphone. je les aies en suite mis dans un tableau excel et exporté en format CSV. 

3. Les données sont constituées du nom de l'application et du nombre de minutes passées (journalier ou la moyenne hebdomadaire). 
